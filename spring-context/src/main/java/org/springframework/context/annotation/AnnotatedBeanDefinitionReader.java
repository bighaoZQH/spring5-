...
public class AnnotatedBeanDefinitionReader {
	 ...
	 *
	 * 这里的BeanDefinitionRegistry是通过AnnotationConfigApplicationContext的构造方法传过来的this
	 * 由此说明AnnotationConfigApplicationContext是一个BeanDefinitionRegistry类型的类
	 * 何以证明，我们可以看到AnnotationConfigApplicationContext的类关系;
	 ...
	 * 那么何为BeanDefinition呢?参考BeanDefinition的源码和注释
	 */
